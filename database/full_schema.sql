...
INSERT IGNORE INTO `parametres_app` (`cle`, `valeur`) VALUES
  ...
  ('product_tier', 'pro'),
  ('module_relances_auto', '1'), ('module_factures_recurrentes', '1'),
  ('module_dashboard_business', '1'), ('module_opportunites', '1'),
  ('relance_jours_1', '7'), ('relance_jours_2', '14'), ('relance_jours_3', '30');
...
-- =============================
-- Business pack (relances, récurrent, opportunités)
-- =============================

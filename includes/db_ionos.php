...
$options = [
    ...
    PDO::ATTR_PERSISTENT         => false,          // plus stable en PaaS
    // Si IONOS impose TLS et te fournit un CA, décommente:
    // PDO::MYSQL_ATTR_SSL_CA => '/app/certs/ionos-ca.pem',
    // PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT => false,
];

$pdoIonos = new PDO($dsnIonos, $IONOS_DB_USER, $IONOS_DB_PASS, $options);

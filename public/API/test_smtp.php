...
/**
 * API de test SMTP - Protégée par token
 * 
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    jsonResponse([
        ...
        'example' => [
            'curl' => 'curl -X POST https://your-domain.com/API/test_smtp.php -H "Content-Type: application/json" -d \'{"token":"your-token","to":"test@example.com"}\''
        ]
    ]);
    exit;
}

...
$availablePages = [
    ...
    'dashboard_business' => 'Pilotage & trésorerie',
                    ...
                    <div class="permissions-grid">
                        ...
                        <div class="permissions-list">
                            ...
                            $pagesByCategory = [
                                ...
                                'Gestion financière' => ['paiements', 'dashboard_business', 'factures_recurrentes', 'opportunites'],
                        ...
                        <?php foreach ($facturesList as $facture): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="/public/view_facture.php?id=<?= (int)($facture['id'] ?? 0) ?>" target="_blank" class="btn-pdf-facture">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                            </svg>
                                            Générer

<?php
/**
 * API/import/ionos_trigger.php
 * Endpoint POST pour déclencher manuellement l'import IONOS
 * 
...
try {
    ...
    $scriptPath = __DIR__ . '/../../scripts/import_ionos_cron.php';
    ...
    echo json_encode([
        ...
        'last_run' => $lastRun ? [
            ...
            'rows_processed' => $messageData['rows_processed'] ?? 0,
            'rows_inserted' => $messageData['rows_inserted'] ?? 0,

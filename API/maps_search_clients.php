...
try {
    ...
    error_log('maps_search_clients.php getPdoOrFail error: ' . $e->getMessage());
...
try {
    ...
    if (!$execResult) {
        ...
        error_log('maps_search_clients.php SQL: ' . $sql);
        error_log('maps_search_clients.php Params count: ' . count($params));
